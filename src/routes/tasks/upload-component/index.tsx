...
import solutionSource from './solution.tsx?raw'
import { Markdown } from '../../../components/Markdown'
import { SourceCode } from '../../../components/SourceCode'
import { Demo } from './demo'

export const Route = createFileRoute('/tasks/upload-component/')({
  component: UploadComponentTask,
})
  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-8">
      ...
      <section className="mb-10">
        ...
        <SourceCode source={solutionSource} lang="tsx" />
      </section>
